...
import { StoriesAddProvider } from './context/StoriesAddContext';
            ...
            <StoriesAddProvider>
              <Router>
                <div className="min-h-screen">
                  ...
                  <div className="px-2 sm:px-[3vw] md:px-[3vw] lg:px-[5vw] pt-8">
                    <ScrollToTop />
                    ...
                    <Routes>
                      ...
                      <Route 
                        path="/f1questionsandanswers/:type" 
                        element={<F1QuestionAndPerAnswer />} 
                      />
