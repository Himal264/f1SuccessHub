...
const StatsSection = () => {
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-8 sm:px-6 md:px-8">
      <div className="max-w-6xl w-full">
        <div className="text-center mb-12">
          ...
          <div className="bg-gray-500 rounded-full p-6 md:p-8 shadow-lg inline-block">
